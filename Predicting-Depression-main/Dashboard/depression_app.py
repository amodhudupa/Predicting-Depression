...
st.markdown("<body style='text-align: center'> <b></b>Prepared By Amodh Udupa, Pothur Vedavikas, Sharath Gowda P, Rahul V<br><br><a href=https://github.com/vedavikas28>- Project repository on GitHub</a><hr style='height:2px;border-width:0;color:gray;background-color:gray'></body>", unsafe_allow_html=True)
